package S.aakashdeep.photoeditor;
...
public class BrushDrawingView extends View {
    ...
    private final Stack<S.aakashdeep.photoeditor.LinePath> mDrawnPaths = new Stack<>();
    private final Stack<S.aakashdeep.photoeditor.LinePath> mRedoPaths = new Stack<>();
